---
title: "Fiche Levier : Optimiser sa voûte pneumatique"
format: 
  html:
    toc: true
  pdf:
...
|------------------|------------------|------------------|--------------------|
| Facile à mettre en œuvre et peu coûteux | Améliore la qualité de pulvérisation | Faible (temps en début de saison) | Faible, la technologie pneumatique ne permet pas de réduire la dérive |
...
::: {#second-column}
![Réglage de l'orientation des diffuseurs à la plaque de fer](images/L1_PlaqueFer.JPG){width="300"}
:::
:::
...
![Voute pneumatique équipée en jet porté](images/L1_ModifVouteJetPorté.JPG){width="300"}
