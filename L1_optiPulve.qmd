  ...
  pdf:
    ...
    include-in-header: 
      text: |
        ...
        \rohead{Optimiser sa voûte pneumatique}
...
![Voute pneumatique Grégoire](images/L1_vouteGregoire.png){width="565"}
...
::: {#second-column}
![Réglage de l'orientation des diffuseurs à la plaque de fer](images/L1_PlaqueFer.png){width="200"}
:::
:::
...
![Voute pneumatique équipée en jet porté](images/L1_ModifVouteJetPorté.png){width="201"}
